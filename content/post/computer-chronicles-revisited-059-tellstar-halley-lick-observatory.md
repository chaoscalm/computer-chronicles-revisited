...
Cheifet said there seemed to be a high correlation between amateur astronomers and computer hobbyists. He asked Kildall if he was ever into astronomy. Kildall noted that he previously taught marine navigation at his grandfather's seamenship school in Seattle many years before starting Digital Research. In that role he regularly used tables, logarithms, and "a lot of addition and subtraction" to chart locations by examining the locations of stars. He said today you just needed to use a little navigation calculator--or if you were really lazy, you could just push a button on a satellite receiver.
