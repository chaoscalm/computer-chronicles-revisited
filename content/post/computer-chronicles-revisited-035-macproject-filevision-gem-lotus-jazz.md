...
+ The Commodore portable machine--known as the Commodore LCD--never made it to market. Management decided to kill the project in order to focus on the Cmomodore 128, which will be featured in an upcoming *Computer Chronicles* episode.
